...
//______________________________________________________
        ...
        textLeft.setText(array.texts5[numLeft]); //Достаем из масива текст
        ...
        img_right.setImageResource(array.images5[numRight]); //Достаем из масива картинку
        textRight.setText(array.texts5[numRight]); //Достаем из масива текст
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN) {
                  ...
                  if (array.strong5[numLeft]>array.strong5[numRight]) {
                    ...
                    if (array.strong5[numLeft]>array.strong5[numRight]){ //Если левая картинка больше
                        if (count<20){
                            count = count+1;
                        }
        ...
        img_right.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN) {
                    ...
                    if (array.strong5[numRight]>array.strong5[numLeft]) {
                    ...
                    if (array.strong5[numRight]>array.strong5[numLeft]){ //Если правая картинка больше
                        if (count<20){
                            count = count+1;
                        }
                        //Закрашиваем прогрес серым цветом начало
